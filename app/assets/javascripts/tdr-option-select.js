...
(function (Modules) {
  ...
  */
  function OptionSelect($module) {
    ...
    this.hasFilter =
      this.$optionSelect.getAttribute("data-filter-element") || "";
  ...
  OptionSelect.prototype.init = function () {
    if (this.hasFilter.length) {
      ...
      this.$optionsContainer.parentNode.insertBefore(
        optionSelectFilter,
    ...
    this.$optionsContainer
      .querySelector(".gem-c-checkboxes__list")
  ...
  OptionSelect.prototype.doFilter = function doFilter(obj) {
    ...
    var lenChecked = obj.$optionsContainer.querySelectorAll(
      ".govuk-checkboxes__input:checked"
    ).length;
    var len = showCheckboxes.length + lenChecked;
    var html =
      len +
      (len === 1 ? obj.filterTextSingle : obj.filterTextMultiple) +
      ", " +
      lenChecked +
      obj.filterTextSelected;
  ...
  OptionSelect.prototype.attachCheckedCounter = function attachCheckedCounter(
    ...
    element.setAttribute(
      "class",
      "app-c-option-select__selected-counter js-selected-counter"
    );
